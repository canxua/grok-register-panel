...
echo "- Live production handoff: docs/CURRENT_STATE.md"
echo "- Architecture: docs/OPERATIONS_ARCHITECTURE.md"
echo "- Convergence gates: docs/CONVERGENCE_AND_GAPS.md"
