...
The target is a Python/Camoufox registration control plane deployed under
systemd on OVH and integrated with a separate CLIProxyAPI/New API data plane.
Runtime auth, account, proxy, and management-key material must remain private.
